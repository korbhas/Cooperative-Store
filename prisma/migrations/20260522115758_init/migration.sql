...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('pending', 'processing', 'out_for_delivery', 'delivered', 'cancelled', 'refunded');
...
-- CreateIndex
CREATE UNIQUE INDEX "delivery_areas_pincode_key" ON "delivery_areas"("pincode");
